...
class LanguageHandler
{
    public const MESSAGES = [
        "en" => [
            ...
            "logout_confirmation_message" => "Logout from account",
            "logout_confirmation_button" => "Logout",
        ...
        "pt-br" => [
            ...
            "logout_confirmation_message" => "Sair da conta",
            "logout_confirmation_button" => "Sair",
